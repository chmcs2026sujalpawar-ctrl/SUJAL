...
const EditMember = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`/api/members/${id}`)
            .then((response) => {
                ...
                setWorkoutSplitType(data.workoutSplitType);
    ...
    return (
        <div className='p-4 max-w-2xl mx-auto'>
            <h1 className='text-3xl font-bold my-4'>Edit Gym Member</h1>
            {loading ? <Spinner /> : ''}
                ...
                <div className='card-body'>
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                        ...
                        <div className='form-control w-full'>
                            ...
                            <input type='text' value={mobileNo} onChange={(e) => setMobileNo(e.target.value)} className='input input-bordered w-full' />
                        </div>
                        ...
                        <div className='form-control w-full'>
                            ...
                            <input type='number' value={initialWeight} onChange={(e) => setInitialWeight(e.target.value)} className='input input-bordered w-full' />
                        </div>

                        {/* Current Weight */}
                        <div className='form-control w-full'>
                            <label className='label'><span className='label-text font-semibold'>Current Weight (kg)</span></label>
                            <input type='number' value={currentWeight} onChange={(e) => setCurrentWeight(e.target.value)} className='input input-bordered w-full' />
                        </div>
                        ...
                        <div className='form-control w-full md:col-span-2'>
                            ...
                            <textarea value={workouts} onChange={(e) => setWorkouts(e.target.value)} className='textarea textarea-bordered h-24 w-full'></textarea>
                        </div>
                    ...
                    <div className="card-actions justify-end mt-8 border-t border-base-200 pt-6">
                        ...
                        <button className='btn btn-warning px-8' onClick={handleEditMember}>
                            Update Member
                        </button>
                    </div>
                </div>
